...
func_header = match.group(1)  # "def _extract_content_parts(...):"
body = match.group(2)  # 函数体

# 检查是否已经支持多段合并
join_pattern = "'".join(texts)"
if 'for item in content' in body and join_pattern in body:
    print('✅ 已支持多段合并，跳过')
    exit(0)
